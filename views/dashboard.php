...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 col-md-2 sidebar">
	<ul style="margin-top:15px;" class="nav menu">
		<li class="active">
			<a href="#">
...
<div class="row-fluid">
	<div class="col-md-12 main">
		<div class="col-sm-9 col-lg-10 col-md-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-3">
				...
				<div class="col-xs-12 col-md-6 col-lg-3">
					<div class="panel panel-blue panel-widget ">
						<div  class="row no-padding">
							<a href="reservation#pending" style="text-decoration:none;">
								<div class="col-sm-3 col-lg-5 widget-left">
									<i class="fa fa-hourglass-half fa-3x"></i>
								</div>
								<div class="col-sm-9 col-lg-7 widget-right">
									<div class="large peding_val">00</div>
			...
			<div style="margin:0 120px;" class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div  class="row no-padding">
						<a href="reservation#reserved" style="text-decoration:none;">
							<div class="col-sm-3 col-lg-5 widget-left">
								<i class="fa fa-thumbs-up fa-3x"></i>
							</div>
							<div class="col-sm-9 col-lg-7 widget-right">
								<div class="large accept_val">00</div>
			...
			<!-- <div class="col-xs-12 col-md-6 col-lg-3">
					<div class="panel panel-teal panel-widget">
						...
						<a href="reservation#reserved" style="text-decoration:none;">
							...
							<div class="col-sm-9 col-lg-7 widget-right">
								<div class="large cancel_val">00</div>
				...
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						<a href="members#" style="text-decoration:none;">
							...
							<div class="col-sm-9 col-lg-7 widget-right">
								<div class="large active_user">00</div>
