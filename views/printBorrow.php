		...
		<tbody>
			<tr>
				...
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">GOVERMENT POLYTECHNIC NAINITAL</p>
					<p style="margin:0;padding:0;font-weight:bold;">NAINITAL UTTARAKHNAD</p>
					<p style="margin:0;padding:0;">DEPARTMENT OF INFORMATION TECHNOLOGY</p>
				</td>
