var table_room =  $('.table_room').DataTable({
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="LMS/assets/mycustom/js/logo.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">GOVERMENT POLYTECHNIC NAINITAL</h4>\
							<h5>NAINITAL UTTARAKHAND</h5>\
	...
	"ajax":
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="logo.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">GOVERMENT POLYTECHNIC NAINITAL</h4>\
							<h5>NAINITAL UTTARAKHAND</h5>\
							<h6>DEPARTMENT OF INFORMATION TECHNOLOGY</h6>\
							</center>',
				customize: function ( win ) {
							...
							dom: "Bfrtip",
									buttons: [
										...
										},
										{
											...
											message: '<center><h4>bhakjjhdflkjhsdfkjsgfdakjh</h4>\
														<h5>NAINITAL UTTARAKHAND</h5>\
														<h6>DEPARTMENT OF INFORMATION TECHNOLOGY</h6>\
														</center>',
											customize: function ( win ) {
							...
							"ajax":
								...
								buttons: [
									...
									},
									{
										...
										message: '<center><h4>GOVERMENT POLYTECHNIC NAINITAL</h4>\
													<h5>NAINITAL UTTARAKHAND</h5>\
													<h6>DEPARTMENT OF INFORMATION TECHNOLOGY</h6>\
													</center>',
										customize: function ( win ) {
