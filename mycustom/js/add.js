...
$('.add_student').click(function(){
	...
	var form = '<form class="frm_add_student">\
					...
					<div class="form-group">\
						...
						<input type="text" name="s_lname" class="form-control text-capitalize">\
					</div>\
					<div class="form-group">\
						<label>Gender</label>\
					...
					<div class="form-group">\
						...
						<input type="tel" name="s_contact" class="form-control">\
					</div>\
					<div class="form-group">\
					...
					<div class="form-group">\
						<div class="row">\
							...
							<div class="col-md-6">\
								<label>Section</label>\
								<input type="text" name="s_section" class="form-control text-capitalize" >\
							</div>\
						</div>\
					</div>\
					<div class="form-group">\
...
$('.add_faculty').click(function(){
	...
	var mform = '<form class="add_frm_faculty">\
					...
					<div class="form-group">\
						<label>Contact Number</label>\
						<input type="tel" name="f_contact" class="form-control">\
					</div>\
					<div class="form-group">\
						<label>Department</label>\
